class AddressCustomer
  ...
  def save
    ...
    Address.create(postcode: postcode, place_id: place_id, city: city, address_line: address_line, building: building, mobile_number: mobile_number, customer_id: customer.id)
