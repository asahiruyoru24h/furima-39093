class Form < ApplicationRecord 
  ...
  def save
    ...
    Address.create(post_code: post_code, place_id: place_id, city: city, address_line: address_line, building: building, mobile_number: mobile_number, purchase_id: purchase_id)
